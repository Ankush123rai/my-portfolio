    ...
    <>
      <div className={style.container}>
        ...
        <motion.div
          ...
          >
          Hello, I am <span className={style.name}>Ankush kumar Rai</span>. I am
          a full stack web developer. I have completed my Bachelor's  in information
          and Technology from{" "}
          ...
          <Link to='https://drive.google.com/file/d/1lH2nq3cS5ZuZeI4uI7BdmTworAMhRyw7/view' target="_blank">
          <motion.button
