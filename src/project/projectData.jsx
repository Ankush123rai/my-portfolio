...
const projectData = [
    {
        id: 1,
        title: 'Grocery Shop',
        description: 'The E-commerce project entails building a dynamic website with CRUD operations, product categorization, search functionality, and user authentication for seamless login and signup experiences.',
        image: project4_1,
        github: "https://github.com/Ankush123rai/Grocery_shop-app",
        live: "https://fresh-grocery.netlify.app/",
        tags: [ 'React.js',' JavaScript', 'CSS','Redux-toolkit', 'Redux-Persist','React-icons','Framer-motion','React-toastify']
    },
    {
        id: 2,
        title: 'kanban board',
